    ...
    <div id="topbar-second" class="topbar">
        <div class="container">
            <ul class="nav" style="width:100%">
                ...
                <span class="top_dropdown">
                    <?php  echo CHtml::dropDownList('countries', '', array('United States', 'Morocco', 'India'), array('class' => 'form-control top_nav'));?>
                </span>
                <span class="top_dropdown">
                    <?php  echo CHtml::dropDownList('state', '', array('Georgia', 'Morroco', 'MH'), array('class' => 'form-control top_nav'));?>
                </span>

                <span class="top_dropdown">
                    <?php  echo CHtml::dropDownList('city', '', array('Atlanta', 'Morroco', 'Mumbai'), array('class' => 'form-control top_nav'));?>
                </span>

                <span class="top_dropdown">
                    <?php  echo CHtml::dropDownList('categories', '', array('categories', 'categories1', 'categories2'), array('class' => 'form-control top_nav'));?>
                </span>
